...
#
# Proyecto_SlaveI2C.tcl: Tcl script for re-creating project 'Proyecto_SlaveI2C'
#
# Generated by Vivado on Sun Jan 16 13:07:51 +0100 2022
...
#
# 1. This project restoration tcl script (Proyecto_SlaveI2C.tcl) that was generated.
#
...
set _xil_proj_name_ "Proyecto_SlaveI2C"
...
set script_file "Proyecto_SlaveI2C.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../Curso_Udemy_Comunicaciones/CursoVHDLComunicaciones/I2C/ProyectoSensorI2C/Proyecto_MasterI2C/Proyecto_SlaveI2C"]"
...
set files [list \
 [file normalize "sources/I2CFsm_Slave.vhd" ]\
 [file normalize "sources/I2C_ReceiveSCL.vhd" ]\
 [file normalize "sources/SYNCHRNZR.vhd" ]\
 [file normalize "sources/TOP.vhd" ]\
]
...
set file "I2CFsm_Slave.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "I2C_ReceiveSCL.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "SYNCHRNZR.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "[file normalize "constrs/Constrains.xdc"]"
...
# Import local files from the original project
set files [list \
 [file normalize "sim/I2C_ReceiveSCL_tb.vhd" ]\
]
...
set file "I2C_ReceiveSCL_tb.vhd"
...
set_property -name "top" -value "I2C_ReceiveSCL_tb" -objects $obj
...
# Import local files from the original project
set files [list \
 [file normalize "sim/I2CFsm_Slave_tb.vhd" ]\
]
